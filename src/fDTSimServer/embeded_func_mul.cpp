...
embeded_func_mul::embeded_func_mul()
{
    _model_type = MODEL_TYPE::EMBEDED_FUNC_MUL;

}

bool embeded_func_mul::load(const string& ip_and_port, Json::Value msg)
{
...
int embeded_func_mul::call_ext_trans_fn(Json::Value msg)
{
    Json::Value out_msg;
    ...
    Json::Value pj;
    pj[PROTOCOL::PORT::PORT_VAL::NAME] = "mul_out";
