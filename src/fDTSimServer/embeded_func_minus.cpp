...
embeded_func_minus::embeded_func_minus()
{
    _model_type = MODEL_TYPE::EMBEDED_FUNC_MINUS;

}

bool embeded_func_minus::load(const string& ip_and_port, Json::Value msg)
{
...
int embeded_func_minus::call_ext_trans_fn(Json::Value msg)
{
    Json::Value out_msg;
    ...
    Json::Value pj;
    pj[PROTOCOL::PORT::PORT_VAL::NAME] = "minus_out";
