...
embeded_func_div::embeded_func_div()
{
    _model_type = MODEL_TYPE::EMBEDED_FUNC_DIV;

}

bool embeded_func_div::load(const string& ip_and_port, Json::Value msg)
{
...
int embeded_func_div::call_ext_trans_fn(Json::Value msg)
{
    Json::Value out_msg;
    ...
    Json::Value pj;
    pj[PROTOCOL::PORT::PORT_VAL::NAME] = "div_out";
