...
class watersrc2(CsModel):
    ...
    def ExtTransFn(self, sim_time, dt, src_model_name, port_name, port_value):
        if port_name == "on_signal" and port_value == 1:
            ...
            self.V = 0.0 
            self.state = 0
        elif port_name == "tank_height" and port_value > 0.0: 
            self.V = 1.0 - self.V_VALUE * port_value
        print("ext", sim_time, dt, self.V) 
